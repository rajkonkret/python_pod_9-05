...
class GradeCalculator:
    ...
    def add_grade(self):
        ...
        avarage = sum(self.grades_dict[student]) / len(self.grades_dict[student])
        self.average_label.config(text="Średnia: " + str(avarage))
