...
class Calculator(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.result_entry.grid(row=0, column=0, columnspan=4, pady=10, ipadx=10)
    ...
    def on_button_click(self, text):
        if text.isdigit() or text == ".":
            ...
            try:
                ...
                self.result_var.set(eval(expression))  # wykonuje działanie na podanym tekscie 2+2, obliczy 4
